    ...
    const scenario1 = await prisma.labScenario.create({
      data: {
        ...
        successCriteria: [
          ...
          {
            id: 'dns_lookup',
            description: 'Perform DNS enumeration with nslookup',
          ...
          {
            id: 'dig_lookup',
            description: 'Perform advanced DNS query with dig',
            command_pattern: '^dig\\s+example-company\\.com',
            expected_output_keyword: 'ANSWER',
            points: 15,
            hint: 'Use dig example-company.com for detailed DNS info',
          },
          {
            id: 'ip_geolocation',
          ...
          },
          {
            ...
            command_pattern: '^ping\\s+192\\.168\\.1\\.100',
            expected_output_keyword: 'bytes from',
            points: 10,
            hint: 'Use ping to test if target is reachable',
          },
          {
            id: 'host_lookup',
            description: 'Perform host lookup for mail servers',
            command_pattern: '^host\\s+example-company\\.com',
            expected_output_keyword: 'mail',
            points: 15,
            hint: 'Use host command to find mail servers',
          },
          {
            id: 'traceroute_target',
            description: 'Trace network path to target',
            command_pattern: '^traceroute\\s+',
            expected_output_keyword: 'hop',
            points: 15,
            hint: 'Use traceroute to map the network path',
          },
        ],
        hints: [
          {
    ...
    const scenario3 = await prisma.labScenario.create({
      data: {
        ...
        successCriteria: [
          ...
          {
            id: 'cve_search_ssh',
            description: 'Search CVE database for SSH vulnerabilities',
            command_pattern: '^searchsploit\\s+(openssh|ssh)',
            expected_output_keyword: 'CVE',
            points: 15,
            hint: 'Use searchsploit openssh to find SSH exploits',
          },
          {
          ...
          {
            id: 'password_crack',
            description: 'Crack password hashes using wordlist',
            command_pattern: '^john\\s+--wordlist',
            expected_output_keyword: 'password',
            points: 25,
            hint: 'Use john --wordlist=rockyou.txt hashes.txt',
          },
          {
            id: 'nmap_vuln_scan',
            description: 'Run vulnerability scan with Nmap scripts',
            command_pattern: '^nmap\\s+--script.*vuln',
            expected_output_keyword: 'VULNERABLE',
            points: 15,
            hint: 'Use nmap --script vuln 192.168.1.100',
          },
          {
            id: 'nikto_scan',
            description: 'Scan web server for vulnerabilities',
            command_pattern: '^nikto\\s+-h',
            expected_output_keyword: 'vulnerability',
            points: 10,
            hint: 'Use nikto -h http://192.168.1.100',
          },
        ],
        hints: [
